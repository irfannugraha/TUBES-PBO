...
public class ViewMotorAdmin extends javax.swing.JFrame {
    
    public ViewMotorAdmin() {
        initComponents();
        reset();
    }
    ...
    private void initComponents() {
        ...
        Accept_btn.setBackground(new java.awt.Color(0, 0, 0));
        Accept_btn.setForeground(new java.awt.Color(255, 255, 255));
        Accept_btn.setText("Perlihatkan");
        Accept_btn.setBorder(null);
        Accept_btn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Accept_btnActionPerformed(evt);
            }
        });
        Selesai_pages.add(Accept_btn);
        Accept_btn.setBounds(20, 160, 90, 30);
        ...
        Delete_btn1.setBackground(new java.awt.Color(0, 0, 0));
        Delete_btn1.setForeground(new java.awt.Color(255, 255, 255));
        Delete_btn1.setText("Perlihatkan");
        ...
        Selesai_pages.add(Delete_btn1);
        Delete_btn1.setBounds(160, 160, 90, 30);
